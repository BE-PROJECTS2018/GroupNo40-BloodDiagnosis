package health.care.com.BEproj.NearbyLocations.GMap;
...
import health.care.com.BEproj.Adapter.CustomPlacesAdapter;
import health.care.com.BEproj.Main2Activity;
import health.care.com.BEproj.NearbyLocations.GeometryController;
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Toast.makeText(ListHealthCenters.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    Main2Activity.progressDialog.cancel();
                    e.printStackTrace();
                    finish();
                }
